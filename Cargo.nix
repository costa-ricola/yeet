  ...
  internal = rec {
    ...
    crates = {
      ...
      "mac-notification-sys" = rec {
        ...
        version = "0.6.11";
        edition = "2024";
        sha256 = "15wsmd3lgwcdy1m345wk6bafjzyg3xj2r4y58fhdczw6yafq52f8";
      ...
      "regex-automata" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "dfa-onepass" "dfa-search" "hybrid" "meta" "nfa-backtrack" "nfa-pikevm" "nfa-thompson" "perf-inline" "perf-literal" "perf-literal-multisubstring" "perf-literal-substring" "std" "syntax" ];
      };
      "regex-syntax" = rec {
      ...
      "ssh2-config" = rec {
        ...
        version = "0.7.0";
        edition = "2024";
        sha256 = "173k7lvj2805z8v62k0810n2ksn0cny031q55bljf0b9afci7f2j";
        build = "build/main.rs";
        libName = "ssh2_config";
        authors = [
      ...
      "uds_windows" = rec {
        ...
        version = "1.2.0";
        edition = "2021";
        sha256 = "1jn2yw59yc7r1kf0s7p00ix7mwps90qdyh0vf59zb4ays63hpdsi";
        authors = [
          "Azure IoT Edge Devs"
      ...
      "yeet" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "ed25519-dalek";
            packageId = "ed25519-dalek";
            features = [ "serde" "serde" "pem" "pkcs8" ];
          }
          {
            name = "env_logger";
      ...
      "yeetd" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "ed25519-dalek";
            packageId = "ed25519-dalek";
            features = [ "serde" "serde" "rand_core" "std" "pem" ];
          }
          {
            name = "httpsig-hyper";
            packageId = "httpsig-hyper";
      ...
      "zlink" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "13bfaa6eb49c89fe8943eed98a89e619ff06ec4e";
